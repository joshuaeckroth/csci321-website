...
- 35% - my bi-weekly performance reviews of each student (7 of them, 5% each)
- 10% - pitch presentation (average of others' scores)
- 10% - weekly update presentations for your team (when it's your turn)
- 10% - completeness of milestone 1
- 10% - completeness of milestone 2
- 10% - completeness of milestone 3
...
Each week, on Wednesdays, I will meet with four students (in rotation) in my office in private. This is our opportunity to talk about any issues with your performance and/or your team's performance. These meetings do not directly affect your grade, though they do help me gain insight for performance reviews.

### Performance Reviews

Every two weeks, I will provide a written evaluation of each student's performance in the class for the prior two weeks. This adds up to seven evaluations. Each is worth 5% of your total grade. Each performance review grade breaks down as follows:

- +1 pt: complete time-tracking information for the prior two weeks
- +2 pts: code contributions meet expectations and similar to or exceed average for the class during the prior two weeks
- +2 pts: my subjective evaluation of your performance; I will write notes to justify my evaluation
...
The whole-class project will be broken up into 4 teams of 3 students each. Every Monday, one person from each of the four teams will present an update (5 mins each). The person presenting from each team will rotate throughout the semester. Each person will present four times throughout the semester. There is no particular grading criteria for these weekly updates; you are graded based on whether you were present and gave your update.

### Milestones

Project milestone requirements will be established after we know which project we will be working on.

Milestone due dates:

- milestone 1: Fri Sep 29, 11am
- milestone 2: Fri Nov 3, 11am
- milestone 3: Fri Dec 8, 11am
...
- W0: Aug 25
  - Pairing, start working on pitch presentations
- W1: Aug 28, Aug 30, Sep 1
  - Mon, work on pitch presentations
  - Wed, deliver pitch presentations
...
- W6: Oct 4, Oct 6
  - Mon, status reports
  - Wed, individual meetings
- W7: Oct 9, Oct 11 (Oct 13: no class)
  - Mon, status reports
  - Wed, individual meetings
